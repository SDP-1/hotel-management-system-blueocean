...
public class IncomeReportsMonthlyTM {
    private int no;
    ...
    public IncomeReportsMonthlyTM(int no, String description, String receivableRs, String receivable$, String receivedRs, String received$) {
        this.no = no;
        this.description = description;
        this.receivableRs = receivableRs;
        this.receivable$ = receivable$;
